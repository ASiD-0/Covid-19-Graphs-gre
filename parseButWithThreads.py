...
def list_with_dates(year=2020, month=11, day=10):
...
def parser():
    while dateRange:
        ...
        if page.status_code != 200:
            ...
            if page.status_code != 200:
                print('could not retrieve page, continue to next page')
                continue
...
if __name__ == '__main__':
    ...
    for i in range(os.cpu_count()):
        ...
        threads.append(Thread(target=parser))
